...
class MyPreTrainedPolicyAction(ActionTerm):
    ...
    cfg: MyPreTrainedPolicyActionCfg
    """The configuration of the action term."""

    def __init__(self, cfg: MyPreTrainedPolicyActionCfg, env: ManagerBasedRLEnv) -> None:
...
@configclass
class MyPreTrainedPolicyActionCfg(ActionTermCfg):
    """Configuration for pre-trained policy action term.

    See :class:`MyPreTrainedPolicyAction` for more details.
    """

    class_type: type[ActionTerm] = MyPreTrainedPolicyAction
    ...
    # -- Action Clipping Ranges --
    vel_x_range: tuple[float, float] = (1.0, 1.0)
    """Range for the commanded linear velocity in x-direction (m/s)."""
    vel_y_range: tuple[float, float] = (0., 0.)
    """Range for the commanded linear velocity in y-direction (m/s)."""
    ang_vel_z_range: tuple[float, float] = (-0., 0.)
    """Range for the commanded angular velocity in z-direction (rad/s)."""
