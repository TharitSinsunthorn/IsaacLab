...
@configclass
class LowGravityMoonbotYonakaRoughEnvCfg(LowGravityLocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.feet_air_time.weight = 0.055 # default 0.125
        ...
        self.rewards.body_lin_acc_l2.weight = -5.0e-4 # default -5.0e-4
        # joint related
        ...
        self.rewards.contact_forces.weight = -0.25 # default -0.25s
        self.rewards.feet_contact_limit.weight = -0.4
...
@configclass
class LowGravityMoonbotYonakaRoughEnvCfg_PLAY(LowGravityMoonbotYonakaRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
