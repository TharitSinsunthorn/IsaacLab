...
class LowGravityUnitreeGo2RoughEnvCfg(LowGravityLocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.commands.base_velocity.ranges = mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(-1.5, 1.5), lin_vel_y=(-0.7, 0.7), ang_vel_z=(-0.8, 0.8), heading=(-math.pi, math.pi))
        ...
        self.rewards.foot_clearance = None # default 0.1 previously None
        ...
        self.rewards.dof_acc_l2.weight = -5.0e-7 # default -2.5
        ...
        self.rewards.energy_scaling.weight = -0.01 # default -0.01
...
class LowGravityUnitreeGo2RoughEnvCfg_PLAY(LowGravityUnitreeGo2RoughEnvCfg):
    def __post_init__(self):
        ...
        # self.events.push_robot = None
        self.events.randomize_gravity_on_reset = None
