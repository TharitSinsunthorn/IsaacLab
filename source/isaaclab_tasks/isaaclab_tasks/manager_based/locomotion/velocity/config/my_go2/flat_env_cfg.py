...
# Import sim_utils to access material configurations
...
class MyUnitreeGo2FlatEnvCfg(MyUnitreeGo2RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.foot_slip.weight = -0.3 ##EDITEDz
...
class MyUnitreeGo2FlatEnvCfg_PLAY(MyUnitreeGo2FlatEnvCfg):
    def __post_init__(self) -> None:
        ...
        # Change the ground plane color
        self.scene.terrain.visual_material = sim_utils.PreviewSurfaceCfg(diffuse_color=(0.6, 0.3, 0.1))
...
class LowGravityUnitreeGo2FlatEnvCfg(LowGravityUnitreeGo2RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.track_ang_vel_z_exp.weight = 0.75 # default 0.75
        self.rewards.feet_air_time.weight = 0.15 # default 0.125
        ...
        self.rewards.ang_vel_xy_l2.weight = -0.2 # default -0.05
        self.rewards.flat_orientation_l2.weight = -0.5 # default -0.05
        ...
        self.rewards.gia_reward = None # default 0.05
...
class LowGravityUnitreeGo2FlatEnvCfg_PLAY(LowGravityUnitreeGo2FlatEnvCfg):
    def __post_init__(self) -> None:
        ...
        self.commands.base_velocity.ranges = mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(1.5, 1.5), lin_vel_y=(-0.0, 0.0), ang_vel_z=(-0.0, 0.0), heading=(-math.pi, math.pi))
        ...
        #     usd_path=f"/home/srl-limb-ws2/Downloads/spacedata_moon_updated/spacedata_moon/moon_simplified.usd",
        # )
        # disable randomization for play
        self.observations.policy.enable_corruption = False
        # remove random pushing event
