...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.3, noise_range=(0.05, 0.1), noise_step=0.05, border_width=0.25
        ),
        ...
        "random_rough1": terrain_gen.HfWaveTerrainCfg(
...
def main():
    ...
    # Set main camera
    sim.set_camera_view([2.5, 2.0, 4.0], [-5.0, 10.0, 3.0])
    # Design scene
